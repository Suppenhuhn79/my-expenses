const googleappApi = {
	 ...
	 * @returns {Promise<void, XhrErrorResponseObject>} Returns a Promise: `resolve()` or `reject(XhrErrorResponseObject)`.
	 */
	 ...
	 * @returns {Promise<String|Object, XhrErrorResponseObject>} Returns a Promise: `resolve(fileContent)` or `reject(XhrErrorResponseObject)`.
	 */
	 ...
	 * @param {XhrQueryDefObject} query Query definition of the request. The hostname may be omitted in the URL, default is `https://www.googleapis.com`. `Authorization` header will be added automatically.
	 * @returns {Promise<any,XhrErrorResponseObject>} Returns a Promise: `resolve(response)` or `reject(XhrErrorResponseObject)`
	 */
	_query: (query) =>
	{
...
/**
 * @typedef XhrErrorResponseObject
 * @type {Object}
 ...
 * @param {Object} [headers] Additional headers as `key=value`-pairs
 * @param {Document | XMLHttpRequestBodyInit} [body] Body data to send
 * @returns {Promise<DOMString|Object,XhrErrorResponseObject>} If the response status code is not a `2xx`, it rejects an `XhrErrorResponseObject`.
